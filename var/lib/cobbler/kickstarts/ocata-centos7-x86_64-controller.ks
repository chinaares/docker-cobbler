...
openstack-config --set /etc/nova/nova.conf DEFAULT my_ip 10.0.0.51
...
openstack-config --set /etc/nova/nova.conf vnc vncserver_listen 10.0.0.51
openstack-config --set /etc/nova/nova.conf vnc vncserver_proxyclient_address 10.0.0.51
...
nova-manage cell_v2 map_cell0 --database_connection mysql+pymysql://root:123456@controller1/nova_cell0

# 创建一个常规cell，名字叫cell1，这个单元格里面将会包含计算节点
nova-manage cell_v2 create_cell --verbose --name cell1 --database_connection mysql+pymysql://root:123456@controller1/nova_cell0 --transport-url rabbit://openstack:123456@controller1:5672/
# 检查部署是否正常
...
openstack-config --set /etc/neutron/plugins/ml2/linuxbridge_agent.ini vxlan local_ip 10.1.1.51
